...
set k_string=unknow
if "%k_mode%"=="Pre-Alpha" set k_string=����Ԥ����
if "%k_mode%"=="Alpha" set k_string=�ڲ����԰�
if "%k_mode%"=="Beta" set k_string=���԰�
if "%k_mode%"=="Release" set k_string=��ʽ��
if "%k_mode%"=="RC" set k_string=����Ԥ���汾
set HOST_ARCH=x86
...
cd /d %initdir%
if not exist %userdir%\init.rc echo ::����Ĭ��ִ�е����������!>%userdir%\init.rc
...
echo #ģ���趨>>%userdir%\UserProfile.conf
